...
setwd("C:/Users/USUARIO/Desktop/M2/Enqu�te Statistique 3")
...
#R4_re en attente de r�soudre le pb des modalites
...
enq.final$E1_re <- factor(enq.final$E1_re,levels = c("Vous n'avez pas internet � la maison", "Oui", "Non"))
table(enq.final$E1_re)

#E2_re#
colnames(enq.final)[229]
class(enq.final$E2_re)
table(enq.final$E2_re) ##D�j� ordonn�e selon le questionaire

#E2_a_re#
colnames(enq.final)[230]
class(enq.final$E2_a_re)
table(enq.final$E2_a_re) ##D�j� ordonn�e selon le questionaire

#E2_b_re#
colnames(enq.final)[231]
class(enq.final$E2_b_re)
table(enq.final$E2_b_re)
enq.final$E2_b_re <- factor(enq.final$E2_b_re, levels = c("Tr�s souvent", "Souvent", "Occasionnellement", "Jamais"))
table(enq.final$E2_b_re)

#E3_re#
colnames(enq.final)[232]
class(enq.final$E3_re)
table(enq.final$E3_re) ##D�j� ordonn�e selon le questionaire

#E3_a_re#
colnames(enq.final)[233]
class(enq.final$E3_a_re)
table(enq.final$E3_a_re) ##D�j� ordonn�e selon le questionaire

#E3_b_re#
colnames(enq.final)[234]
class(enq.final$E3_b_re)
table(enq.final$E3_b_re)
enq.final$E3_b_re <- factor(enq.final$E3_b_re, levels = c("Tr�s souvent", "Souvent", "Occasionnellement", "Jamais"))
table(enq.final$E3_b_re)

#E4_re#
colnames(enq.final)[235]
class(enq.final$E4_re)
table(enq.final$E4_re) ##D�j� ordonn�e selon le questionaire

#E4_a_re#
colnames(enq.final)[236]
class(enq.final$E4_a_re)
table(enq.final$E4_a_re) ##D�j� ordonn�e selon le questionaire

#E4_b_re#
colnames(enq.final)[237]
class(enq.final$E4_b_re)
table(enq.final$E4_b_re)
enq.final$E4_b_re <- factor(enq.final$E4_b_re, levels = c("Tr�s souvent", "Souvent", "Occasionnellement", "Jamais"))
table(enq.final$E4_b_re)

#E5_re#
colnames(enq.final)[238]
class(enq.final$E5_re)
table(enq.final$E5_re) ##D�j� ordonn�e selon le questionaire

#E5_a_re#
colnames(enq.final)[239]
class(enq.final$E5_a_re)
table(enq.final$E5_a_re) ##D�j� ordonn�e selon le questionaire

#E5_b_re#
colnames(enq.final)[240]
class(enq.final$E5_b_re)
table(enq.final$E5_b_re)
enq.final$E5_b_re <- factor(enq.final$E5_b_re, levels = c("Tr�s souvent", "Souvent", "Occasionnellement", "Jamais"))
table(enq.final$E5_b_re)

#E6_re#
colnames(enq.final)[241]
class(enq.final$E6_re)
table(enq.final$E6_re) ##D�j� ordonn�e selon le questionaire

#E6_a_re#
colnames(enq.final)[242]
class(enq.final$E6_a_re)
table(enq.final$E6_a_re) ##D�j� ordonn�e selon le questionaire

#E6_b_re#
colnames(enq.final)[243]
class(enq.final$E6_b_re)
table(enq.final$E6_b_re)
enq.final$E6_b_re <- factor(enq.final$E6_b_re, levels = c("Tr�s souvent", "Souvent", "Occasionnellement", "Jamais"))
table(enq.final$E6_b_re)

#E7_re#
colnames(enq.final)[244]
class(enq.final$E7_re)
table(enq.final$E7_re) ##D�j� ordonn�e selon le questionaire

#E7_a_re#
colnames(enq.final)[245]
class(enq.final$E7_a_re)
table(enq.final$E7_a_re) ##D�j� ordonn�e selon le questionaire

#E7_b_re#
colnames(enq.final)[246]
class(enq.final$E7_b_re)
table(enq.final$E7_b_re)
enq.final$E7_b_re <- factor(enq.final$E7_b_re, levels = c("Tr�s souvent", "Souvent", "Occasionnellement", "Jamais"))
table(enq.final$E7_b_re)

#E8_re#
colnames(enq.final)[247]
class(enq.final$E8_re)
table(enq.final$E8_re) ##D�j� ordonn�e selon le questionaire

#E8_a_re#
colnames(enq.final)[248]
class(enq.final$E8_a_re)
table(enq.final$E8_a_re) ##D�j� ordonn�e selon le questionaire

#E8_b_re#
colnames(enq.final)[249]
class(enq.final$E8_b_re)
table(enq.final$E8_b_re)
enq.final$E8_b_re <- factor(enq.final$E8_b_re, levels = c("Tr�s souvent", "Souvent", "Occasionnellement", "Jamais"))
table(enq.final$E8_b_re)
