...
enq.final_v2 <- read.csv2("./_Data/BDD réconciliée/BDD/enq final_v2.csv",encoding="UTF-8")
...
ech <- data.frame(cbind(enq.final_v2[,"id_r"],enq.final_v2[,"D13_re"],enq.final_v2[,"age_calage"],enq.final_v2[,"D5_re"],1))
